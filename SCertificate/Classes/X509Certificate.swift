...
public class X509Certificate: CustomStringConvertible, SCertificate {
    ...
    public var userName: String? {
        if let subjectDName = subjectDistinguishedName {
            return String(subjectDName.split(separator: ",")[0].split(separator: "=")[1])
        }
        return nil
    }
